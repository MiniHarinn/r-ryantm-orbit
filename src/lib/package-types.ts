...
export const STATUS_META: Record<number, StatusMeta> = {
  ...
  1: {
    label: "Success",
    className: "status-success-border status-success-text",
  },
  2: {
    label: "Skipped",
    className: "status-warning-border status-warning-text",
  },
  3: {
    label: "Duplicate",
    className: "status-indigo-border status-indigo-text",
  },
  4: {
    label: "No change",
    className: "status-nochange-border status-nochange-text",
  },
  5: {
    label: "Invalid",
    className: "status-invalid-border status-invalid-text",
  },
}
