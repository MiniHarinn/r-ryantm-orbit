...
type ChunkRow = [number, string, number, number, string | null]
          ...
          return (
            ...
            >
              <div className="flex flex-wrap items-start justify-between gap-3">
                ...
                <Badge
                  variant="outline"
                  className={`px-3 py-1 text-[11px] uppercase tracking-[0.2em] ${statusMeta.className}`}
                >
                  {statusMeta.label}
                </Badge>
              </div>
              ...
              <div className="rounded-2xl border bg-background px-3 py-2">
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  View the log for update details.
                </p>
              </div>
